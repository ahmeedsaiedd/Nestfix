                        ...
                        @foreach ($tickets as $ticket)
                            <tr class="hover:bg-gray-100 transition-colors duration-200">
                                <form method="POST" action="{{ route('tickets.update', $ticket->id) }}" class="w-full">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $ticket->closed_at ? $ticket->closed_at->format('Y-m-d H:i') : 'N/A' }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                        ...
                                        <button type="submit" class="mt-2 px-4 py-2 bg-blue-500 text-white rounded-lg">Save</button>
                                    </td>
                                </form>
                            </tr>
                        @endforeach
